...
public class TechBlockEntityTypes {
    ...
    public static final IRegistryObject<BlockEntityType<GravityBlockEntity>> GRAVITY = BLOCK_ENTITIES.register("gravity", () -> Services.PLATFORM.createBlockEntityType(GravityBlockEntity::new, TechBlocks.ATTRACTOR.get(), TechBlocks.REPULSOR.get(), TechBlocks.GRAVITOR.get()));
    public static final IRegistryObject<BlockEntityType<GravityDirectionalBlockEntity>> GRAVITY_DIRECTIONAL = BLOCK_ENTITIES.register("gravity_directional", () -> Services.PLATFORM.createBlockEntityType(GravityDirectionalBlockEntity::new, TechBlocks.ATTRACTOR_DIRECTIONAL.get(), TechBlocks.REPULSOR_DIRECTIONAL.get(), TechBlocks.GRAVITOR_DIRECTIONAL.get()));
