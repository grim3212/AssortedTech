...
public class TechRecipes extends RecipeProvider {
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		...
		ConditionalRecipe.builder().addCondition(new EnabledCondition(EnabledCondition.GRAVITY_CONDITION)).addRecipe(ShapedRecipeBuilder.shaped(TechItems.GRAVITY_BOOTS.get(), 1).define('I', Tags.Items.INGOTS_IRON).define('A', TechBlocks.ATTRACTOR.get()).pattern("I I").pattern("A A").unlockedBy("has_attractor", has(TechBlocks.ATTRACTOR.get()))::save).generateAdvancement().build(consumer, TechItems.GRAVITY_BOOTS.getId());

		ConditionalRecipe.builder().addCondition(new EnabledCondition(EnabledCondition.GRAVITY_CONDITION)).addRecipe(ShapedRecipeBuilder.shaped(TechBlocks.ATTRACTOR.get(), 1).define('C', Items.COMPASS).define('R', Tags.Items.DUSTS_REDSTONE).define('E', Tags.Items.ENDER_PEARLS).define('I', Tags.Items.INGOTS_IRON).pattern("IRI").pattern("RCR").pattern("IEI").unlockedBy("has_ender_pearl", has(Tags.Items.ENDER_PEARLS))::save).generateAdvancement().build(consumer, TechBlocks.ATTRACTOR.getId());
		ConditionalRecipe.builder().addCondition(new EnabledCondition(EnabledCondition.GRAVITY_CONDITION)).addRecipe(ShapedRecipeBuilder.shaped(TechBlocks.GRAVITOR.get(), 1).define('C', Items.COMPASS).define('R', Tags.Items.DUSTS_REDSTONE).define('E', Tags.Items.ENDER_PEARLS).define('I', Tags.Items.INGOTS_IRON).pattern("IRI").pattern(" C ").pattern("IEI").unlockedBy("has_ender_pearl", has(Tags.Items.ENDER_PEARLS))::save).generateAdvancement().build(consumer, TechBlocks.GRAVITOR.getId());
		ConditionalRecipe.builder().addCondition(new EnabledCondition(EnabledCondition.GRAVITY_CONDITION)).addRecipe(ShapedRecipeBuilder.shaped(TechBlocks.REPULSOR.get(), 1).define('C', Items.COMPASS).define('R', Tags.Items.DUSTS_REDSTONE).define('E', Tags.Items.ENDER_PEARLS).define('I', Tags.Items.INGOTS_IRON).pattern("RIR").pattern("ICI").pattern("RER").unlockedBy("has_ender_pearl", has(Tags.Items.ENDER_PEARLS))::save).generateAdvancement().build(consumer, TechBlocks.REPULSOR.getId());

		ConditionalRecipe.builder().addCondition(new EnabledCondition(EnabledCondition.GRAVITY_CONDITION)).addRecipe(ShapedRecipeBuilder.shaped(TechBlocks.ATTRACTOR_DIRECTIONAL.get(), 1).define('C', Items.COMPASS).define('R', Tags.Items.DUSTS_REDSTONE).define('E', Tags.Items.ENDER_PEARLS).define('I', Tags.Items.INGOTS_IRON).pattern("IRI").pattern("RCR").pattern(" E ").unlockedBy("has_ender_pearl", has(Tags.Items.ENDER_PEARLS))::save).generateAdvancement().build(consumer,
				TechBlocks.ATTRACTOR_DIRECTIONAL.getId());
		ConditionalRecipe.builder().addCondition(new EnabledCondition(EnabledCondition.GRAVITY_CONDITION)).addRecipe(ShapedRecipeBuilder.shaped(TechBlocks.GRAVITOR_DIRECTIONAL.get(), 1).define('C', Items.COMPASS).define('R', Tags.Items.DUSTS_REDSTONE).define('E', Tags.Items.ENDER_PEARLS).define('I', Tags.Items.INGOTS_IRON).pattern(" R ").pattern("ICI").pattern(" E ").unlockedBy("has_ender_pearl", has(Tags.Items.ENDER_PEARLS))::save).generateAdvancement().build(consumer,
				TechBlocks.GRAVITOR_DIRECTIONAL.getId());
		ConditionalRecipe.builder().addCondition(new EnabledCondition(EnabledCondition.GRAVITY_CONDITION)).addRecipe(ShapedRecipeBuilder.shaped(TechBlocks.REPULSOR_DIRECTIONAL.get(), 1).define('C', Items.COMPASS).define('R', Tags.Items.DUSTS_REDSTONE).define('E', Tags.Items.ENDER_PEARLS).define('I', Tags.Items.INGOTS_IRON).pattern("RIR").pattern("ICI").pattern(" E ").unlockedBy("has_ender_pearl", has(Tags.Items.ENDER_PEARLS))::save).generateAdvancement().build(consumer,
