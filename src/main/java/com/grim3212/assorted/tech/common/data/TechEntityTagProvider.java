...
public class TechEntityTagProvider extends EntityTypeTagsProvider {
	...
	protected void addTags() {
		...
		this.tag(TechTags.Entities.SENSORS_WATER).add(EntityType.TURTLE, EntityType.DOLPHIN, EntityType.ELDER_GUARDIAN, EntityType.GUARDIAN, EntityType.PUFFERFISH, EntityType.SALMON, EntityType.SQUID, EntityType.TROPICAL_FISH, EntityType.DROWNED);
