...
public class TechItems {
	...
	public static final RegistryObject<GravityArmorItem> GRAVITY_BOOTS = register("gravity_boots", () -> new GravityArmorItem(EquipmentSlot.FEET, new Item.Properties().tab(AssortedTech.ASSORTED_TECH_ITEM_GROUP)));
