...
public class BridgeBakedModel extends BridgeBaseBakedModel {
	...
	public BridgeBakedModel(BakedModel bakedColorizer, UnbakedModel unbakedModel, IModelConfiguration owner, TextureAtlasSprite baseSprite, ModelBakery bakery, Function<Material, TextureAtlasSprite> spriteGetter, ModelState transform, ItemOverrides overrides, ResourceLocation name) {
